...
from api_reminders import bp as api_reminders_bp
...
from api_vault import bp as api_vault_bp
...
app.register_blueprint(api_reminders_bp)
...
app.register_blueprint(api_vault_bp)
